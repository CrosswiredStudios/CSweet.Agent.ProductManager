...
The agent package version is `1.3.0`.
...
Requirements are .NET 10, `CSweet.Agent.SDK` 1.1.1, `CSweet.Memory`, an approved protocol-v2 installation, an active managing employee, and the grants in [GRANTS.md](GRANTS.md).
